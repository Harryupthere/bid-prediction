      ...
      <div className="bg-center w-screen m-auto px-3 pt-20 pb-12 lg:block xl:px-0 ">
        <div className="lg:grid max-w-7xl mx-auto  grid-cols-1  md:grid-cols-2  flex flex-col flex-col-reverse  PageBG rounded-xl shadow-2xl">
          ...
          <div className="  rounded-xl     flex  justify-center items-center flex-col w-full  ">
            ...
            <div className="my-4  w-full text-center">
              <h1 className="sm:text-lg text-sm text-gray-100">Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one. </h1>
            </div>
            ...
            <div className=" pt-0 w-full my-3">
                            ...
                            <p className="antialiased font-sans text-md font-light leading-normal text-inherit mt-6 flex justify-end text-gray-100">Don't have an account?
